...
def display_data_from_masks(data, output_path, frame_rate=4, roundness=0, graph_format='png'):
    """
    ...
    for d in density:
        ...
        plot_conditions(data_display, variable, "Cell size (pixels)", "Subcategory-01", output_path,
                        d + "_" + variable + "_roundness-{0}.{1}".format(roundness, graph_format), style_condition="processing")
