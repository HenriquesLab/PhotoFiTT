...
for f in os.listdir(folder):
    print(f)
    # Read the image
    seq = tifffile.imread(os.path.join(folder, f))
    ...
    for t in range(seq.shape[0]):
        ...
        # save_tiff_imagej_compatible(os.path.join(new_folder, f.split(".tif")[0] + "_{:02d}.tif".format(t)), image_resized, "yx")

        tifffile.imsave(os.path.join(new_folder, f.split(".tif")[0] + "_{:02d}.tif".format(t)),
