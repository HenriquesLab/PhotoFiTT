...
dynamics_metrics = extract_dynamics_metrics(main_path, method=method, save_steps=False)
dynamics_metrics.to_csv(os.path.join(output_path, folder, "data_dynamics_{}.csv".format(method)))
