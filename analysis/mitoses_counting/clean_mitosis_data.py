...
dynamics_metrics = pd.read_csv(
    os.path.join(output_path, folder, "data.csv"))
...
print(len(dynamics_metrics))
dynamics_metrics.to_csv(os.path.join(output_path, folder, "data_clean.csv"))
...
### ---------------------------------------
# print(len(data))
# dynamics_metrics = data[data['Subcategory-01']=='WL UV - high density'].reset_index(drop=True)
# print(len(dynamics_metrics))
...
# dynamics_metrics = dynamics_metrics.drop(index)
#
# dynamics_metrics.to_csv(os.path.join(output_path, folder, "data_UV_clean.csv"))
...
### ---------------------------------------
# print(len(data))
# dynamics_metrics = data[data['Subcategory-01']== 'WL 568 - high density'].reset_index(drop=True)
# print(len(dynamics_metrics))
# dynamics_metrics.to_csv(os.path.join(output_path, folder, "data_568_clean.csv"))